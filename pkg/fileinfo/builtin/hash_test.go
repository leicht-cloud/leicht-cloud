...
var units = []struct {
	...
	{
		"SHA384",
		newHashProvider(func() hash.Hash { return sha512.New384() }),
	...
	{
		"SHA512",
		newHashProvider(func() hash.Hash { return sha512.New() }),
	...
	{
		"SHA3-224",
		newHashProvider(func() hash.Hash { return sha3.New224() }),
	...
	{
		"SHA3-256",
		newHashProvider(func() hash.Hash { return sha3.New256() }),
	...
	{
		"SHA3-384",
		newHashProvider(func() hash.Hash { return sha3.New384() }),
	...
	{
		"SHA3-512",
		newHashProvider(func() hash.Hash { return sha3.New512() }),
